...
class OLLSolver(Solver):
    STEPS = {
        ...
        "BURLUUFFL": ["F'", "L'", "U'", "L", "U", "L'", "U'", "L", "U", "F"],
        "LUBLUULFF": ["R'", "F", "R'", "F'", "R2", "U2", "X'", "U'", "R", "U", "R'"],
        "BUBLUUFFF": ["R'", "F", "R", "F'", "U2", "R2", "Y", "R'", "F'", "R", "F'"],
        "BBUUUFLUF": ["R", "U", "R'", "Y", "R'", "F", "R", "U'", "R'", "F'", "R"],
        ...
        "UBULUULUR": ["R2", "U", "R'", "B", "R", "U'", "R2", "U", "X'", "R", "U", "X", "R'"],
